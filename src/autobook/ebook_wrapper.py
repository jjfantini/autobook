...
argParser = argparse.ArgumentParser(description="Extract text from EPUB files")
...
def parseCommandLine():
    ...
    argParser.add_argument(
        "dirOut", action="store", type=str, help="output directory"
    )
    # Parse arguments
...
# fileIn = "Anthony Doerr - Cloud Cuckoo Land.epub"
# fileOut = "Anthony Doerr - Cloud Cuckoo Land.txt"
